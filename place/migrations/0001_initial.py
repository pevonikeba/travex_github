    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_of_terrain_description', models.TextField(blank=True, null=True)),
                ...
                ('category', models.ManyToManyField(blank=True, related_name='categories', to='place.category', verbose_name='categories')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vibe', models.CharField(default=None, max_length=255)),
                ('image', models.ImageField(blank=True, null=True, upload_to='images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Walking', 'Walking'), ('Biking', 'Biking'), ('Cars', 'Cars'), ('Trains', 'Trains'), ('Buses', 'Buses'), ('Boats', 'Boats'), ('Subways', 'Subways'), ('Aerial Tramways', 'Aerial Tramways'), ('Flying', 'Flying'), ('Funiculars', 'Funiculars')], default=None, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('place', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='safes', to='place.place')),
            ],
        ),
        migrations.AddField(
            model_name='place',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default=None, max_length=255)),
                ('type_cuisine', models.CharField(blank=True, max_length=255)),
                ('description', models.TextField(blank=True)),
                ('image', models.ImageField(blank=True, null=True, upload_to='images/')),
